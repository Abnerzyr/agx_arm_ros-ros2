...
echo "=== Starting GG-CNN ==="
ros2 run agx_arm_vision ggcnn_grasp &>/tmp/ggcnn.log &
GGCNN_PID=$!
echo "  ggcnn_grasp PID=$GGCNN_PID"

sleep 2

echo "=== All started (GG-CNN) ==="
echo "CAN=$CAN_PORT  MoveIt=$MOVEIT_PID  Cam=$CAM_PID  GGCNN=$GGCNN_PID  Grasp=$GRASP_PID"
echo ""
